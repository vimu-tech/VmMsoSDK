...
void AdvPlot::CreateLine(lineattribute* line)
{
	...
	if(line->pctName == CH_NAME[0])
		lineatr->m_axis = &m_leftaxis;
	else if (line->pctName == CH_NAME[1])
		lineatr->m_axis = &m_rightaxis;
	else if (line->pctName == CH_NAME[2])
		lineatr->m_axis = &m_ch3axis;
