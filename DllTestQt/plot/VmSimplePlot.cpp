...
void VmSimplePlot::updateDatas(int real_length, int sample/*QVariantList list*/)
{
...
void VmSimplePlot::updatDevState(int devstate)
{
    if(devstate==1)
    {
        int m_captureLength = GetMemoryLength()*1024;
