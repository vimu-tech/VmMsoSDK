	<Item Name="Abort Capture.vi" Type="VI" URL="../VIs/Abort Capture.vi"/>
	<Item Name="Cal Freq.vi" Type="VI" URL="../VIs/Cal Freq.vi"/>
	...
	<Item Name="Get DDS Burst Period Ns.vi" Type="VI" URL="../VIs/Get DDS Burst Period Ns.vi"/>
	<Item Name="Get DDS Burst Style.vi" Type="VI" URL="../VIs/Get DDS Burst Style.vi"/>
	<Item Name="Get DDS Cur Boxing Amplitude Mv.vi" Type="VI" URL="../VIs/Get DDS Cur Boxing Amplitude Mv.vi"/>
	<Item Name="Get DDS Cur Boxing Bias Mv Max.vi" Type="VI" URL="../VIs/Get DDS Cur Boxing Bias Mv Max.vi"/>
	<Item Name="Get DDS Cur Boxing Bias Mv Min.vi" Type="VI" URL="../VIs/Get DDS Cur Boxing Bias Mv Min.vi"/>
	<Item Name="Get DDS Depth.vi" Type="VI" URL="../VIs/Get DDS Depth.vi"/>
	<Item Name="Get DDS Loops Num Infinity.vi" Type="VI" URL="../VIs/Get DDS Loops Num Infinity.vi"/>
	<Item Name="Get DDS Loops Num.vi" Type="VI" URL="../VIs/Get DDS Loops Num.vi"/>
	<Item Name="Get DDS Out Mode.vi" Type="VI" URL="../VIs/Get DDS Out Mode.vi"/>
	<Item Name="Get DDS Output Gate Enge.vi" Type="VI" URL="../VIs/Get DDS Output Gate Enge.vi"/>
	<Item Name="Get DDS Support Boxing Style.vi" Type="VI" URL="../VIs/Get DDS Support Boxing Style.vi"/>
	<Item Name="Get DDS Sweep Start Freq.vi" Type="VI" URL="../VIs/Get DDS Sweep Start Freq.vi"/>
	<Item Name="Get DDS Sweep Stop Freq.vi" Type="VI" URL="../VIs/Get DDS Sweep Stop Freq.vi"/>
	<Item Name="Get DDS Sweep Time.vi" Type="VI" URL="../VIs/Get DDS Sweep Time.vi"/>
	...
	<Item Name="Init Dll.vi" Type="VI" URL="../VIs/Init Dll.vi"/>
	<Item Name="IO Enable.vi" Type="VI" URL="../VIs/IO Enable.vi"/>
	<Item Name="Is DAC Enable.vi" Type="VI" URL="../VIs/Is DAC Enable.vi"/>
	<Item Name="Is Data Ready.vi" Type="VI" URL="../VIs/Is Data Ready.vi"/>
	<Item Name="Is DDS Output Enable.vi" Type="VI" URL="../VIs/Is DDS Output Enable.vi"/>
	<Item Name="Is Dev Available.vi" Type="VI" URL="../VIs/Is Dev Available.vi"/>
	<Item Name="Is IO Enable.vi" Type="VI" URL="../VIs/Is IO Enable.vi"/>
	<Item Name="Is IO Read State Ready.vi" Type="VI" URL="../VIs/Is IO Read State Ready.vi"/>
	<Item Name="Is Support Ac Dc.vi" Type="VI" URL="../VIs/Is Support Ac Dc.vi"/>
	<Item Name="Is Support DDS Device.vi" Type="VI" URL="../VIs/Is Support DDS Device.vi"/>
	<Item Name="Is Support Hard Trigger.vi" Type="VI" URL="../VIs/Is Support Hard Trigger.vi"/>
	<Item Name="Is Support IO Device.vi" Type="VI" URL="../VIs/Is Support IO Device.vi"/>
	...
	<Item Name="Set Data Ready Event.vi" Type="VI" URL="../VIs/Set Data Ready Event.vi"/>
	<Item Name="Set DDS Amplitude Mv.vi" Type="VI" URL="../VIs/Set DDS Amplitude Mv.vi"/>
	<Item Name="Set DDS Bias Mv.vi" Type="VI" URL="../VIs/Set DDS Bias Mv.vi"/>
	<Item Name="Set DDS Boxing Style.vi" Type="VI" URL="../VIs/Set DDS Boxing Style.vi"/>
	<Item Name="Set DDS Burst Delay Ns.vi" Type="VI" URL="../VIs/Set DDS Burst Delay Ns.vi"/>
	<Item Name="Set DDS Burst Period Ns.vi" Type="VI" URL="../VIs/Set DDS Burst Period Ns.vi"/>
	<Item Name="Set DDS Burst Style.vi" Type="VI" URL="../VIs/Set DDS Burst Style.vi"/>
	<Item Name="Set DDS Duty Cycle.vi" Type="VI" URL="../VIs/Set DDS Duty Cycle.vi"/>
	<Item Name="Set DDS Loops Num Infinity.vi" Type="VI" URL="../VIs/Set DDS Loops Num Infinity.vi"/>
	<Item Name="Set DDS Loops Num.vi" Type="VI" URL="../VIs/Set DDS Loops Num.vi"/>
	<Item Name="Set DDS Out Mode.vi" Type="VI" URL="../VIs/Set DDS Out Mode.vi"/>
	<Item Name="Set DDS Output Gate Enge.vi" Type="VI" URL="../VIs/Set DDS Output Gate Enge.vi"/>
	<Item Name="Set DDS Pinlv.vi" Type="VI" URL="../VIs/Set DDS Pinlv.vi"/>
	<Item Name="Set DDS Sweep Start Freq.vi" Type="VI" URL="../VIs/Set DDS Sweep Start Freq.vi"/>
	<Item Name="Set DDS Sweep Stop Freq.vi" Type="VI" URL="../VIs/Set DDS Sweep Stop Freq.vi"/>
	<Item Name="Set DDS Sweep Time.vi" Type="VI" URL="../VIs/Set DDS Sweep Time.vi"/>
	<Item Name="Set DDS Trigger Source Enge.vi" Type="VI" URL="../VIs/Set DDS Trigger Source Enge.vi"/>
	<Item Name="Set DDS Trigger Source Io.vi" Type="VI" URL="../VIs/Set DDS Trigger Source Io.vi"/>
	<Item Name="Set DDS Trigger Source.vi" Type="VI" URL="../VIs/Set DDS Trigger Source.vi"/>
	<Item Name="Set Dev Notice Call Back.vi" Type="VI" URL="../VIs/Set Dev Notice Call Back.vi"/>
	...
	<Item Name="Update DDS Arb Buffer.vi" Type="VI" URL="../VIs/Update DDS Arb Buffer.vi"/>
	<Item Name="vmmso.dll" Type="Document" URL="../vmmso.dll"/>
</Library>
